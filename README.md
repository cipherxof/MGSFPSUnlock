...
2. Extract to your MGS2/MGS3/MGS4 install location (i.e `C:\Program Files (x86)\Steam\steamapps\common\METAL GEAR SOLID 4\MGS4`)
...
- Open up the game properties in Steam and add `WINEDLLOVERRIDES="winmm,wininet,winhttp=n,b" %command%` to the launch options.
